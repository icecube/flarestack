...
data_dir = dataset_dir + "ps_tracks_240418/"
...
IC40_dict = {
    "Name": "IC40",
    "exp_path": data_dir + "IC40_exp.npy",
    "mc_path": data_dir + "IC40_corrected_MC.npy",
    "grl_path": data_dir + "IC40_GRL.npy"
}
IC40_dict.update(ps_dict)

IC59_dict = {
    "Name": "IC59",
    "exp_path": data_dir + "IC59_exp.npy",
    "mc_path": data_dir + "IC59_corrected_MC.npy",
    "grl_path": data_dir + "IC59_GRL.npy"
}
...
IC79_dict = {
    "Name": "IC79",
    "exp_path": data_dir + "IC79b_exp.npy",
    "mc_path": data_dir + "IC79b_corrected_MC.npy",
    "grl_path": data_dir + "IC79b_GRL.npy"
}
...
IC86_1_dict = {
    "Name": "IC86_1",
    "exp_path": data_dir + "IC86_exp.npy",
    "mc_path": data_dir + "IC86_corrected_MC.npy",
    "grl_path": data_dir + "IC86_GRL.npy"
}
