    ...
    for gamma in gammas:
        ...
        for sindec in same_sindecs:
            ...
            for i, n in enumerate(np.array(nsources)):
                ...
                name = gamma_name + '{:.4f}/'.format(sindec) + str(n) + 'sources' if sindec is not None \
    ...
    for gamma, sin_res in gamma_res.items():
        ...
        for sindec in same_sindecs:
            ...
            ax.errorbar(sens[0],
                        ...
                        marker='', ls='-', capsize=3, label=f'flarestack')
            ...
            ax2.set_ylabel(r"$F \, \cdot \, F_{\mathrm{point \, source \, reference}}^{-1} \, \cdot \, N_{\mathrm{sources}}^{-1}$")
            ax2.set_xscale('log')
            ax2.set_yscale('log')
