...
def skylab_northern_only_data(cat, gamma, kernel=0, seasons=None):
    fn = (
        f"{Path.home()}/scratch/skylab_scratch/skylab_output/data/sn_catalogue_crosscheck_northern/"
...
def skylab_spatial_only_data(cat, gamma, kernel=0, season=None):
    ...
    fn = (
        f"{Path.home()}/scratch/skylab_scratch/skylab_output/data/sn_catalogue_crosscheck{season_str}/"
