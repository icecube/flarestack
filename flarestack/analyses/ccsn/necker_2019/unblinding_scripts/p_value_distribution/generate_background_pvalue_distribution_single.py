...
from flarestack.analyses.ccsn.necker_2019.ccsn_helpers import sn_cats, sn_time_pdfs, raw_output_dir
        ...
        for cat in use_cats:
            ...
            for llh_time in time_pdfs:
                ...
                for gamma in gammas:
                    ...
                    ub = create_unblinder(unblind_dict, mock_unblind=True, disable_warning=True, seed=seeds[0])
                    ...
                    for s in seeds[1:]:
                        ...
                        raw_p_value = len(bkg_ts_array[bkg_ts_array > ts]) / len(bkg_ts_array)
