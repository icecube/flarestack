...
inj_dict = {
    "Injection Time PDF": {"Name": "FixedEndBox"},
...
llh_energy_tm = {"Name": "Spline", "Spline Path": spline_name(0)}
...
if n_over == 0:
    print(
        "No trials above tested value. More statistics needed. We will "
