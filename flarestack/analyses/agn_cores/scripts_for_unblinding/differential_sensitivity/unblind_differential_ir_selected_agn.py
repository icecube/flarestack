"""Script to unblind the IR-selected AGN sample (32249 sources) in terms of differential significance/upper limits.
Draws the background TS values generated by differential_sensitivit/diff_sens_ir_selected_agn_analysis.py,
