"""Script to unblind the IR-selected AGN sample (32249 sources). Draws the background TS values
generated by ir_selected_agn_analysis.py, in order to quantify the significance of the result.
...
# Unblind the total IR-selected AGN sample (not sub-selection of brightest sources)
