...
class TestCosmoRates(unittest.TestCase):
    ...
    def test_tde_rates(self):
        ...
        f_mid, f_low, f_high = get_rate("tde", evolution_name="biehl_18_jetted", m=-2, with_range=True)
        true = [2.e-07 / (u.Mpc**3 * u.yr), 1.e-07 / (u.Mpc**3 * u.yr), 3.e-07 / (u.Mpc**3 * u.yr)]
    ...
    def test_grb_rates(self):
        ...
        f_mid, f_low, f_high = get_rate("grb", evolution_name="lien_14", with_range=True)
        true = [
