...
All required dependencies can be found using the IceCube py2-v3 environment. They can collectively be installed with _pip install -r requirements.txt_, if for some reason you don't want to install flarestack via pip..
